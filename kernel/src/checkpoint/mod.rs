...
impl CheckpointWriter {
    ...
    /// [`crate::log_replay::HasSelectionVector::apply_selection_vector`] applied. Declarative-plan
    /// executors use it when registering materialized checkpoint batches (for example before a
    /// [`crate::plans::ir::nodes::SinkType::Write`] parquet sink).
