...
//! - [`phase_operation`] / [`operation_type`] — typed "unit of work" handed from SM to executor
//!   each step.
//! - [`phase_kdf_state`] — thread-safe container accumulating per-partition
//!   [`FinishedHandle`](crate::plans::kdf::FinishedHandle)s that the executor returns to the SM.
...
//! - [`coroutine`] — [`CoroutineSM`](coroutine::engine::CoroutineSM), the async-fn-backed
