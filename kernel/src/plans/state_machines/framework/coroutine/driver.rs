...
/// identity stamping (e.g. reducer handles emitted by [`EngineRequest::Reduce`]).
...
impl<R: 'static> CoroutineSM<R> {
    ...
    /// SM-rooted artifacts (reducer handles, diagnostic logs).
...
mod tests {
    use super::*;
    use crate::plans::state_machines::framework::coroutine::context::StepYield;
    use crate::plans::state_machines::framework::engine_error::{EngineError, EngineErrorKind};
    use crate::plans::state_machines::framework::step::SchemaQuery;
