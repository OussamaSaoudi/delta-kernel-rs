...
fn generate_primitive_extract(
    ...
    if *prim == PrimitiveType::Void {
        return Ok(Expr::Literal(datafusion_common::ScalarValue::Null, None));
    }
    ...
    let udf = match prim {
        ...
        | PrimitiveType::IntervalDayTime => json_get_int_udf(),
        ...
        PrimitiveType::Void => json_get_str_udf(),
    };
    ...
    let target_type = match prim {
        ...
        PrimitiveType::IntervalYearMonth => Some(ArrowDataType::Int32),
        PrimitiveType::IntervalDayTime => Some(ArrowDataType::Int64),
